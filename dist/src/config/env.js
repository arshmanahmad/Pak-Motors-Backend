...
if (fs_1.default.existsSync(envPath)) {
    ...
    if (fs_1.default.existsSync(defaultEnvPath)) {
        ...
        console.error(`No environment file found: tried .env.${nodeEnvironment} and .env`);
    }
}
exports.env = (0, envalid_1.cleanEnv)(process.env, {
    NODE_ENV: (0, envalid_1.str)({
        devDefault: (0, envalid_1.testOnly)("test"),
    ...
    CORS_ORIGIN: (0, envalid_1.str)({
        devDefault: (0, envalid_1.testOnly)("http://localhost:3001;http://localhost:3000"),
    }),
    ...
    MONGO_URL: (0, envalid_1.url)({
        devDefault: (0, envalid_1.testOnly)("mongodb://localhost:27017/wrytify-db"),
    }),
